  ...
  <div class="row g-4">
    <div class="col-md-3 d-flex">
      <div class="content-container p-3 d-flex flex-column">
        <img src="../GLOBAL/img/mouvement.png" alt="Réactivité" class="icon">
        <h3>RÉACTIVITÉ</h3>
        ...
        <div class="col-md-3 d-flex">
          <div class="content-container p-3 d-flex flex-column">
            <img src="../GLOBAL/img/humanitaire.png" alt="Réactivité" class="icon">
            <h3>HUMAIN</h3>
            ...
            <div class="col-md-3 d-flex">
              <div class="content-container p-3 d-flex flex-column">
                <img src="../GLOBAL/img/confort.png" alt="Réactivité" class="icon">
                <h3>CONFORT</h3>
...
<br><br>
  <div class="container_paris">
    <div class="content">
      ...
      <div class="img_paris">
        <img src="../GLOBAL/img/tour-eiffel.jpg" alt="Image Paris">
      </div>
    </div>
    <div class="text-container">
      ...
      <a href="en_savoir_plus.php" class="en-savoir-plus">En savoir +</a>
    </div>
  </div>
 ...
 <!-- Container Plage -->
  <div class="container_plage">
    <div class="content">
      ...
      <div class="img_plage">
        <img src="../GLOBAL/img/plage.jpg" alt="Image Plage">
      </div>
    </div>
    <div class="text-container">
