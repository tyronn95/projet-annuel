...
<body>
        ...
        <div class="container_paris">
            <div class="content">
            <div class="img_paris">
                <img src="organisation.jpg" alt="Image Paris">
            </div>
            </div>
            <div class="text-container">
            <span class="underline">Mise en valeur des publications : </span> <br> - Découvrez des logements mis en valeur à travers des annonces attrayantes, complétées par une communication fluide avec les voyageurs. <br><br>
            </p><br><br>
                <!-- <div class="text-center mt-3">
                    <button id="monBouton" class="btn">Réserver</button>
                </div>        -->
                <form id="myForm" method="post">
                    <input type="text" id="pub" placeholder="Entrez votre texte ici">
        ...
        <div class="container_plage">
            <div class="content">
            <div class="img_plage">
                <img src="nettoyage.jpg" alt="Image Plage">
            </div>
            </div>
            <div class="text-container">
        ...
        <div class="container_paris">
            <div class="content">
            <div class="img_paris">
                <img src="service.png" alt="Image Paris">
            </div>
            </div>
            <div class="text-container">
        ...
        <div class="container_plage">
            <div class="content">
            <div class="img_plage">
                <img src="argent.jpeg" alt="Image Plage">
            </div>
            </div>
            <div class="text-container">
        ...
        <div class="content">
            <div class="img_paris">
                <img src="maintenance.jpg" alt="Image Paris">
            </div>
        </div>
        <div class="text-container">
    ...
    <div class="container_plage">
        <div class="content">
        <div class="img_plage">
            <img src="vtc.jpg" alt="Image Plage">
        </div>
        </div>
        <div class="text-container">
